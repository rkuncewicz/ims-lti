...
(function() {
  ...
  Provider = (function() {
    function Provider(arg) {
      var consumer_key, consumer_secret, nonceStore, providerOptions, ref, ref1, signature_method;
      ref = arg != null ? arg : {}, consumer_key = ref.consumer_key, consumer_secret = ref.consumer_secret, nonceStore = ref.nonceStore, signature_method = (ref1 = ref.signature_method) != null ? ref1 : new HMAC_SHA1(), providerOptions = ref.providerOptions;
      ...
      if (providerOptions != null) {
        this.authEnabled = providerOptions.authEnabled != null ? providerOptions.authEnabled : true;
      } else {
    ...
    Provider.prototype._valid_oauth = function(req, body, callback) {
      ...
      if (!valid_signature && this.authEnabled) {
