...
(function() {
  ...
  Provider = (function() {
    function Provider(arg) {
      var authEnabled, consumer_key, consumer_secret, nonceStore, ref, ref1, ref2, signature_method;
      ref = arg != null ? arg : {}, consumer_key = ref.consumer_key, consumer_secret = ref.consumer_secret, nonceStore = ref.nonceStore, signature_method = (ref1 = ref.signature_method) != null ? ref1 : new HMAC_SHA1(), authEnabled = (ref2 = ref.authEnabled) != null ? ref2 : true;
