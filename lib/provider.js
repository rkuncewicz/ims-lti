...
(function() {
  ...
  Provider = (function() {
    ...
    Provider.prototype._valid_parameters = function(body) {
      var correct_message_type, correct_version, has_resource_link_id, ref, supported_message_types;
      if (!body) {
        return false;
      }
      supported_message_types = ['basic-lti-launch-request', 'ContentItemSelectionRequest'];
      correct_message_type = (ref = body.lti_message_type, indexOf.call(supported_message_types, ref) >= 0);
      correct_version = require('./ims-lti').supported_versions.indexOf(body.lti_version) !== -1;
      has_resource_link_id = (body.resource_link_id != null) || body.lti_message_type === supported_message_types[1];
